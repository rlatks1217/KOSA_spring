...
<body>
	...
	<h3>requestScope.newStudent.studentNumber : ${ requestScope.newStudent.studentNumber }</h3>
	<h3>requestScope.newStudent.studentName : ${ requestScope.newStudent.studentName }</h3>
	<h3>requestScope.newStudent.studentDept : ${ requestScope.newStudent.studentDept }</h3>
	<br><br>
	<h2>sessionScope</h2>
	<h3>sessionScope.data1 : ${ sessionScope.data1 }</h3>
	<h3>sessionScope.shin.studentName : ${ sessionScope.newStudent.studentName }</h3>
